...
class Config(object):
	...
	MONITOR_CHANNELS = list(int(x) for x in os.environ.get("MONITOR_CHANNELS", "").split())
	REPOST_CHANNEL = os.environ.get("REPOST_CHANNEL", None)  # Channel where formatted posts will be sent
